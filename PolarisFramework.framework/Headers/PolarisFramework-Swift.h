...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PolarisFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16PolarisFramework16BindableTextView")
@interface BindableTextView : UITextView <UITextViewDelegate>
...
SWIFT_CLASS("_TtC16PolarisFramework14DatabaseObject")
...
SWIFT_CLASS("_TtC16PolarisFramework18PolarisAppDelegate")
@interface PolarisAppDelegate : UIResponder <UIApplicationDelegate>
...
SWIFT_CLASS("_TtC16PolarisFramework16PolarisTableView")
@interface PolarisTableView : UITableView
...
@interface PolarisTableView (SWIFT_EXTENSION(PolarisFramework)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC16PolarisFramework20PolarisTableViewCell")
@interface PolarisTableViewCell : UITableViewCell
...
SWIFT_CLASS("_TtC16PolarisFramework23PolarisUIViewController")
@interface PolarisUIViewController : UIViewController
...
@interface PolarisUIViewController (SWIFT_EXTENSION(PolarisFramework)) <UIViewControllerTransitioningDelegate>
